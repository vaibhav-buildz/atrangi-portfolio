...
${this.wrapWithColor("›ï¸ Institution:", "#ff8c00")} ${this.wrapWithColor(
...
${this.wrapWithColor(
  ...
  showSkills(outputElement = this.output) {
    const skills = `<span style="color: #ffff00; font-weight: bold;">› ï¸ PROGRAMMING</span>
    ...
    try {
      ...
      const weatherHTML = `<div class="weather-container">
        <div class="weather-header">
          <span style="color: #ffff00; font-weight: bold;">Œ¤ï¸ Weather for ${data.name
